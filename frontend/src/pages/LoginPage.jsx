  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="backdrop-blur-md bg-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <input
                ...
                className="w-full px-5 py-3.5 rounded-full bg-white/20 backdrop-blur-sm 
            ...
            <button
              type="submit"
              className="w-full py-3.5 mt-4 rounded-full bg-rose-700 hover:bg-rose-800 
          ...
          {/* Links */}
          <div className="flex justify-between items-center mt-6 text-white/80 text-sm">
            <a 
              href="#" 
          ...
          <div className="text-center">
            <p className="text-white/80 text-sm mb-4">OR LOGIN WITH</p>
